...
ENV["QUEUE_HOST"] = TopologicalInventory::Scheduler::ClowderConfig.instance["kafkaHost"]
ENV["QUEUE_PORT"] = TopologicalInventory::Scheduler::ClowderConfig.instance["kafkaPort"].to_s

# ManageIQ Logger depends on these variables
ENV['CW_AWS_ACCESS_KEY_ID']     = TopologicalInventory::Scheduler::ClowderConfig.instance["awsAccessKeyId"]
ENV['CW_AWS_SECRET_ACCESS_KEY'] = TopologicalInventory::Scheduler::ClowderConfig.instance["awsSecretAccessKey"]
